...
function showResult() {
    ...
    const mapping = {
      "ACEG": { name: "沃伦·巴菲特", title: "价值苦行僧 · 时间的信徒", desc: "你拥有极度稀缺的“延迟满足”能力。在你的世界里，市场波动不是风险，而是获取廉价筹码的恩赐。", img: "images/ACEG.webp" },
      "ACEH": { name: "查理·芒格", title: "睿智杠精 · 逻辑的化身", desc: "你是典型的“多元思维模型”践行者。你不仅关注财务报表，更关注心理学、历史学和物理学对商业的影响。", img: "images/ACEH.webp" },
      "ACFG": { name: "詹姆斯·西蒙斯", title: "量化之神 · 数学建模者", desc: "你相信世界万物皆可量化。你用数学模型取代了人类的直觉，通过高频交易在市场的微小波动中提取利润。", img: "images/ACFG.webp" },
      "ACFH": { name: "彼得·林奇", title: "消费观察家 · 生活中的猎手", desc: "你坚信“投资就在身边”。你不依赖复杂的数学模型，而是通过观察商场里谁在排队、谁在买单来捕捉牛股。", img: "images/ACFH.webp" },
      "ADEG": { name: "霍华德·马克斯", title: "周期预言家 · 逆向思维者", desc: "你是“第二层次思维”的信徒。当所有人都在欢呼时，你看到了风险；当所有人都在绝望时，你看到了机会。", img: "images/ADEG.webp" },
      "ADEH": { name: "凯西·伍德", title: "创新狂热粉 · 信仰的信徒", desc: "你是未来的赌徒。你对颠覆性技术有着近乎偏执的信仰，愿意为了 5 年后的爆发而忍受现在的剧烈波动。", img: "images/ADEH.webp" },
      "ADFG": { name: "乔治·索罗斯", title: "混乱制造者 · 反身性大师", desc: "你深谙“反身性”原理，认为市场不仅反映现实，更能改变现实。你擅长通过做空来挑战泡沫。", img: "images/ADFG.webp" },
      "ADFH": { name: "孙宇晨", title: "流量收割机 · 空气币操盘手", desc: "你深谙人性，明白在金融市场中，共识就是最大的价值，而流量是共识的源头。", img: "images/ADFH.webp" },
      "BCEG": { name: "塞斯·卡拉曼", title: "安全边际卫士 · 极度防御者", desc: "你把“不亏钱”视为投资的第一原则。你通过极低的价格买入资产，构建巨大的安全边际。", img: "images/BCEG.webp" },
      "BCEH": { name: "约翰·博格", title: "指数躺平派 · 拒绝折腾者", desc: "你是“大道至简”的极致。你认为试图战胜市场是徒劳的，于是你选择了拥抱市场。", img: "images/BCEH.webp" },
      "BCFG": { name: "瑞·达利欧", title: "原则机器 · 经济模型构建者", desc: "你像是一个在操作经济机器的工程师。你通过“全天候组合”来对抗各种经济环境。", img: "images/BCFG.webp" },
      "BCFH": { name: "彼得·蒂尔", title: "反共识狂人 · 从0到1者", desc: "你是“反共识”的践行者。你认为竞争是平庸的，只有垄断才是成功的。", img: "images/BCFH.webp" },
      "BDEG": { name: "杰西·利弗莫尔", title: "投机之王 · 孤独的狩猎者", desc: "你深知市场情绪的波动，擅长在趋势中获利，并懂得在危险来临时迅速离场。", img: "images/BDEG.webp" },
      "BDEH": { name: "徐翔", title: "涨停板敢死队 · 极致博弈者", desc: "你对盘面语言、资金流向和情绪周期有着恐怖的敏感度。你追求的是极致的效率。", img: "images/BDEH.webp" },
      "BDFG": { name: "葛卫东", title: "趋势之王 · 重仓博弈者", desc: "你是天生的“趋势猎手”。你敢于在关键时刻重仓出击，捕捉大级别的行情。", img: "images/BDFG.webp" },
      "BDFH": { name: "朋友圈韭菜", title: "气氛组组长 · 追涨杀跌先锋", desc: "你是市场的“燃料”。你总是听风就是雨，哪里热闹往哪钻。", img: "images/BDFH.webp" }
    };
